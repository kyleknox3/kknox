...
<html>                                    <!-- open html tag: required  -->
  ...
  <head>                                  <!-- open page header: required -->
    <title>Kyle Knox</title>      <!-- page title appears on the tab -->
  ...
  <body style="background-image: url('gradient-black-background-with-wavy-lines_23-2149157312.webp')">   <!-- open html body: required -->
  <BR><BR>
   ...
   <table align = "center"  border = "0"  width=85%  bordercolor="gold"  bgcolor = "white">        
     <tbody>
      ...
      <!--TD  style="background-image: url('table.jpeg'); width:2%;"></TD--> 
      <!--TD bgcolor='#003366'--> 
      <TD style="background-image: url('table.jpeg')" style="width:30%">
        <table border = "0" bordercolor="darkgreen" align = "center"
        width="100%" height = "100%" style = "border-spacing: 0"> 
           <tr>
            <TD style = "line-height: 20%;">
                <BR><BR><BR><BR><BR><BR><BR><BR>
                <center><img src="IMG_0808.JPG" width=150 height=210>
                <h3  style="padding-bottom: 0px;"><font color = "black"><br>&nbsp; Kyle Knox</font></h3>
                <p0><font color = "black">&nbsp; Aspiring Data Scientist <br><br><br><br></font></p0>
                <BR><BR><BR><BR><BR>
           ...
           <tr>
            <TD style = "line-height: 30%;">
                ...
                <p0><font color = "black">
                    &nbsp; Data Analyst II <br><br><br>
                    &nbsp; Weston Solutions Inc.<br><br><br>
                    &nbsp; West Chester, PA 19382<br><br><br>
                    &nbsp; Phone: 1-717-357-2888<br><br><br>
                    &nbsp; Email: kylephilip003@gmail.com <br><br><br><br>
                    <!--/font></p0>
                    <!--hr color="black">
                    <p0><font color = "black"--> 
                    &nbsp; <a href="https://github.com/kyleknox3" style="text-decoration: none;"  target="_blank"  
                     onclick="window.open('https://github.com/kyleknox3','name','width=700, height=500')">
                     <font color = "black">https://github.com/kyleknox3</font></a><br><br>
                    </font></p0>
                    <hr color="gray">
            </TD>
          </tr>
           ...
           <TD style = "line-height: 110%;">
              <h4 style="padding-bottom: 0px; margin: 0;"><font color = "#123456">Projects/Presenations</font></h4>
               <!--font color = "blue" size="4"-->
                 <a href="https://rpubs.com/kyleknox3/flights" target="_blank">Does Number of Flights Influence Arrival Delays</a> 
                    </font></p>
               <!--/font-->
               <hr color="lightblue">
            </TD>
